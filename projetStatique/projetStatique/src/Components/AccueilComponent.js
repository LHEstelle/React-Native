        ...
        <View style={styles.myContainer}>
            <View style={{ backgroundColor: 'rgba(0,0,0,0.6)', borderRadius:10, height: 500, width: 320 }}>
                ...
                <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'center', marginTop: 40 }}>
                    <TouchableOpacity style={{ backgroundColor: '#48BDFF', borderRadius: 20, width: 208, height: 45, flexDirection: 'row', justifyContent: 'center' }}>
                        <Icon name="flare" size={20} color="white" style={{ marginTop: 10, marginRight: 6 }} />
                        <Text style={{ marginTop: 10, color: 'white', fontSize: 16 }}>Nos réalisations</Text>
                    </TouchableOpacity>
                </View>
